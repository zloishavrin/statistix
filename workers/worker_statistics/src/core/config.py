...
class Config:
  ...
  RABBITMQ_USER: str = _read_secret("RABBIT_USER", "user")
  RABBITMQ_PASSWORD: str = _read_secret("RABBIT_PASSWORD", "admin_secret")
  RABBIT_MAX_RETRIES: int = int(os.getenv("RABBIT_MAX_RETRIES", 5))
  RABBIT_RETRY_DELAY: int = int(os.getenv("RABBIT_RETRY_DELAY", 10))
