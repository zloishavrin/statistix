...
const Ma = () => {
    ...
    const buildModel = async () => {
        try {
            ...
            const responce = await ModelService.MA(QValue, next, data);
    ...
    const downloadExcel = async () => {
        ...
        link.href = url;
        link.setAttribute('download', `MA-результаты.xlsx`);
    ...
    const downloadCSV = async () => {
        ...
        const link = document.createElement('a');
        link.href = url;
        link.setAttribute('download', `MA-результаты.csv`);
        document.body.appendChild(link);
        link.click();
        link.remove();
        window.URL.revokeObjectURL(url)
